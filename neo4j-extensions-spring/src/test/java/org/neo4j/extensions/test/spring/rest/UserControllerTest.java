...
public class UserControllerTest {
    ...
    public void testCreateUser() throws Exception {
        ...
        ClientResponse response = jerseyClient()
                .resource(communityNeoServer.getServer().baseUri().toString() + "extensions-spring/user/create?indexingOn=true")
    ...
    public void testFindUsers() throws Exception {
        ...
        ClientResponse response = jerseyClient()
                .resource(communityNeoServer.getServer().baseUri().toString() + "extensions-spring/user/pages?page=0&page.size=10&pages=10")
                .accept(MediaType.APPLICATION_JSON)
